    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <main className="container mx-auto px-6 py-8">
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Summary</h2>
          <Card>
            <CardContent className="pt-6">
              <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
                <li>Third-year Computer Science student with strong analytical and critical thinking skills</li>
                <li>Proficient in Cloud-based data storage, computing, and security strategies</li>
                <li>Skilled in Data Analysis & Visualization tools for insightful reporting and interpretation</li>
                <li>Understanding of the Software Development Life Cycle and Agile Methodologies</li>
              </ul>
            </CardContent>
          </Card>
        </section>
            ...
            {[
              ...
              <Card key={index}>
                <CardHeader>
                  ...
                  <CardDescription>{job.company} | {job.date}</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-wrap gap-2">
                {[
                  "Python", "SQL", "JavaScript", "TypeScript", "React Native", "Node.js", "Linux", "Spring",
                  "AWS", "Google Cloud Platform", "Figma", "MongoDB", "Firebase", "JIRA", "Azure", "Django",
                  "Angular", "Open AI", "Vertex AI"
                ].map((skill, index) => (
        ...
        <section className="mb-12">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sheridan College | Expected 2026</CardDescription>
            </CardHeader>
          </Card>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Extra-Curricular Activities</h2>
          <Card>
            <CardContent className="pt-6">
              <p className="text-gray-600 dark:text-gray-300">Vice President of Sheridan Swiftie Club</p>
            </CardContent>
          </Card>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Certifications</h2>
          <Card>
            <CardContent className="pt-6">
              <p className="text-gray-600 dark:text-gray-300">Actively working on AWS Cloud Practitioner Certification</p>
            </CardContent>
          </Card>
        </section>
      </main>
      ...
      <footer className="bg-white dark:bg-gray-800 shadow mt-12">
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-center space-x-6">
            <a href="mailto:vidhikalal15@gmail.com" className="text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white">
              <Mail className="h-6 w-6" />
            </a>
            <a href="tel:+16478975185" className="text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white">
              <Phone className="h-6 w-6" />
            </a>
            <a href="https://linkedin.com/in/vidhi-kalal" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white">
              <Linkedin className="h-6 w-6" />
            </a>
            <a href="https://github.com/Vidhikalal" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white">
